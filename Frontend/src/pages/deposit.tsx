      ...
      <div className="min-h-screen p-6 bg-background">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <header className="text-center space-y-4">
            <h1 className="text-5xl font-bold text-gradient bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">
              Manage Your Vault
            </h1>
            <p className="text-lg text-foreground-500">
              Securely deposit, withdraw, and track your vUSDT assets.
            </p>
          </header>
            ...
            <Card className="lg:col-span-1">
              ...
              <CardBody className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full"
                >
                  Mint 1000 vUSDT (Owner Only)
                </Button>
              </CardBody>
            </Card>

            {/* Vault Overview */}
            <Card className="lg:col-span-2 bg-gradient-to-br from-violet-50 to-indigo-50 dark:from-violet-950/20 dark:to-indigo-950/20 border-violet-200 dark:border-violet-800">
              <CardHeader>
                <div className="flex items-center space-x-2">
              ...
              <CardBody className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-foreground-500">Deposited</span>
                    </div>
                    <Chip color="success" variant="flat" size="sm">
                      {parseFloat(vaultData.deposited).toFixed(2)} vUSDT
                    </Chip>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                      <Lock className="text-warning" size={16} />
                      <span className="text-sm text-foreground-500">Locked</span>
                    </div>
                    <Chip color="warning" variant="flat" size="sm">
                      {parseFloat(vaultData.locked).toFixed(2)} vUSDT
                    </Chip>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-foreground-500">Available</span>
                    </div>
                    <Chip color="primary" variant="flat" size="sm">
                      {parseFloat(vaultData.available).toFixed(2)} vUSDT
                    </Chip>
                  </div>
                </div>
                ...
                <div className="bg-default-100 p-4 rounded-lg">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground-500">Wallet Balance:</span>
                    <span className="font-semibold text-violet-600">
                      {parseFloat(vusdtBalance).toLocaleString()} vUSDT
                    </span>
                  </div>
                ...
                <div className="bg-violet-100 dark:bg-violet-900/20 p-4 rounded-lg">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground-500">Total Vault Deposits:</span>
                    <span className="font-semibold text-lg text-violet-700 dark:text-violet-300">
                      {parseFloat(vaultData.deposited).toFixed(2)} vUSDT
                    </span>
                  </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-xl font-semibold">Deposit to Vault</h3>
                </div>
              </CardHeader>
              <CardBody className="space-y-4">
                <Input
                ...
                <Button
                  ...
                  size="lg"
                  onPress={handleDeposit}
                  startContent={<ArrowUpCircle size={20} />}
                  className="w-full"
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-xl font-semibold">Withdraw from Vault</h3>
                </div>
              </CardHeader>
              <CardBody className="space-y-4">
                <Input
                ...
                <Button
                  ...
                  size="lg"
                  onPress={handleWithdraw}
                  startContent={<ArrowDownCircle size={20} />}
                  className="w-full"
