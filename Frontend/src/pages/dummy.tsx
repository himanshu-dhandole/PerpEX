...
//     <DefaultLayout>
//       {/* === HERO SECTION === */}
//       <AuroraBackground className="dark:bg-black relative overflow-hidden">
...
//               Professional trading platform built with modern React UI
//               components.
//               <br />
...
//                   infrastructure and real-time market data.
//                 </p>
//                 <Chip
//                   color="success"
//                   variant="flat"
...
//               <CardBody className="pt-0">
//                 <p className="text-sm text-gray-600">
//                   Amplify your trading potential with leverage up to 50x on
...
//               <CardBody className="pt-0">
//                 <p className="text-sm text-gray-600">
//                   Trade with confidence using bank-grade security and cold
//                   storage protection.
//                 </p>
//                 <Chip
//                   color="primary"
